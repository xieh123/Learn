 ...
 */
public class VideoPlayActivity extends AppCompatActivity implements CacheListener {
    ...
    private String videoUrl = "http://mpv.videocc.net/ce0812b122/a/ce0812b122bf0fb49d79ebd97cbe98fa_1.mp4";
    ...
    private void initView() {
        ...
        HttpProxyCacheServer cacheServer = MyApplication.getProxy(this);
        proxyVideoUrl = cacheServer.getProxyUrl(videoUrl, true);
        if (cacheServer.isCached(videoUrl)) {
            Log.e("hh", "-------离线播放");
        } else {
            cacheServer.registerCacheListener(this, videoUrl);
        }
...
//        uri = Uri.fromFile(file);
        ...
        // test mp4
        MediaSource videoSource = new ExtractorMediaSource(Uri.parse(proxyVideoUrl), dataSourceFactory, extractorsFactory, null, null);
...
//                    initPlayVideo();
    ...
    public void onCacheAvailable(File cacheFile, String url, int percentsAvailable) {
        Log.e("hh", "-------正在缓存----" + percentsAvailable);
    }
}
