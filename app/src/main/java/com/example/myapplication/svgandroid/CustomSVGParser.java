...
public class CustomSVGParser {
    ...
    public static SVG getSVGFromInputStream(InputStream svgData) throws SVGParseException {
        return CustomSVGParser.parse(svgData, null, false);
    }
    ...
    public static SVG getSVGFromString(String svgData) throws SVGParseException {
        return CustomSVGParser.parse(new ByteArrayInputStream(svgData.getBytes()), null, false);
    }
    ...
    public static SVG getSVGFromResource(Resources resources, int resId) throws SVGParseException {
        return CustomSVGParser.parse(resources.openRawResource(resId), null, false);
    }
    ...
    public static SVG getSVGFromInputStream(InputStream svgData, HashMap<String, Integer> colorMap) throws SVGParseException {
        return CustomSVGParser.parse(svgData, colorMap, false);
    }
    ...
    public static SVG getSVGFromString(String svgData, HashMap<String, Integer> colorMap) throws SVGParseException {
        return CustomSVGParser.parse(new ByteArrayInputStream(svgData.getBytes()), colorMap, false);
    }
    ...
    public static SVG getSVGFromResource(Resources resources, int resId, HashMap<String, Integer> colorMap) throws SVGParseException {
        return CustomSVGParser.parse(resources.openRawResource(resId), colorMap, false);
    }
     ...
     * @throws IOException       if there was a problem reading the file.
     */
    public static SVG getSVGFromAsset(AssetManager assetMngr, String svgPath, HashMap<String, Integer> colorMap) throws SVGParseException, IOException {
        InputStream inputStream = assetMngr.open(svgPath);
        SVG svg = getSVGFromInputStream(inputStream, colorMap);
        inputStream.close();
        return svg;
    }
    ...
    private static SVG parse(InputStream in, HashMap<String, Integer> colorMap, boolean whiteMode) throws SVGParseException {
        ...
        try {
            ...
            //    svgHandler.setColorSwap(searchId, replaceColor);

            svgHandler.setColorMap(colorMap);
    ...
    private static class SVGHandler extends DefaultHandler {
        ...
        public void setColorSwap(String searchId, Integer replaceColor) {
        ...
        private boolean doFill(Properties atts, HashMap<String, Shader> gradients) {
            ...
            if (fillString != null) {
                if (fillString.startsWith("url(#")) {
                    ...
                    String pathId = atts.getString("id");

                    if (pathId != null && colorMap.containsKey(pathId)) {
                        color = colorMap.get(pathId);
                    }
        ...
        private void doColor(Properties atts, Integer color, boolean fillMode, Paint paint) {
            ...
            if (searchId != null && searchId.equals(pathId)) {
                c = replaceColor;
            }
            paint.setColor(c);
