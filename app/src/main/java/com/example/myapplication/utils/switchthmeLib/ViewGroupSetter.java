package com.example.myapplication.utils.switchthmeLib;
...
public class ViewGroupSetter extends ViewSetter {
    ...
    public void setValue(Theme newTheme, int themeId) {
        ...
        // 修改所有子元素的相关属性
        changeChildrenAttrs((ViewGroup) mView, newTheme, themeId);
    }
     ...
     * @param themeId
     */
    private void changeChildrenAttrs(ViewGroup viewGroup, Theme newTheme,
                                     int themeId) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childView instanceof ViewGroup) {
                changeChildrenAttrs((ViewGroup) childView, newTheme, themeId);
            }
