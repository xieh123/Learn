...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandableTextView_collapseExpandTextColor, ContextCompat.getColor(getContext(), R.color.text_light_color));
        ...
        gravity = typedArray.getInt(R.styleable.ExpandableTextView_collapseExpandGravity, Gravity.LEFT);
        drawableGravity = typedArray.getInt(R.styleable.ExpandableTextView_drawableGravity, Gravity.RIGHT);
...
//            mTvContent.setMaxLines(mMaxCollapsedLines);
    ...
    private void setDrawbleAndText() {
        if (Gravity.LEFT == drawableGravity) {
