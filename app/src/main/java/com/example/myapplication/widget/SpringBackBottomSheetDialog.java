...
public class SpringBackBottomSheetDialog extends AppCompatDialog {
    ...
    public void addSpringBackDisLimit(final int targetLimitH) {
        ...
        mCoordinatorLayout.setOnTouchListener(
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        ...
        mCoordinatorLayout = (CoordinatorLayout) container.findViewById(R.id.coordinatorLayout);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, mCoordinatorLayout, false);
        }
        bottomSheet = (FrameLayout) mCoordinatorLayout.findViewById(R.id.content_fl);
        ...
        mCoordinatorLayout.findViewById(R.id.touch_outside).setOnClickListener(new View.OnClickListener() {
            @Override
