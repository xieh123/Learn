 ...
 */
public class ParallaxImageView11 extends AppCompatImageView {
    ...
    public ParallaxImageView11(Context context) {
        this(context, null);
    }

    public ParallaxImageView11(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ParallaxImageView11(Context context, AttributeSet attrs, int defStyle) {
